...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.user_role'
        db.add_column(u'notifications_notification', 'user_role',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Notification.notify_type'
        db.add_column(u'notifications_notification', 'notify_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.user_role'
        db.delete_column(u'notifications_notification', 'user_role')

        # Deleting field 'Notification.notify_type'
        db.delete_column(u'notifications_notification', 'notify_type')
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            'notify_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 14, 0, 0)'}),
            'unread': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'user_role': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
